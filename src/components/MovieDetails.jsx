...
function MovieDetails() {
  ...
  const {movieDetails, UpdateMovieDetails} = useContext(AppContext);
  ...
  return (
    <div className = 'bg-gray-400 w-full min-w-0 max-w-full box-border p-[20px]'>
        ...
        <div className='relative w-full max-w-[300px] h-[180px] overflow-hidden rounded-lg mx-auto'>
                    ...
                    <span className='absolute inset-0 flex items-center justify-center text-white font-bold px-2 text-center bg-black/30'>{movieDetails.name}</span>
                </div>
